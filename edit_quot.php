        ...
        <div class="card">
          ...
          <div class="px-4">
              ...
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="name" class="form-control" name="name" required value="<?php echo $_GET['name'] ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Mobile No</label>
                      <input type="text" id="mobile" class="form-control" name="mobile" required value="<?php echo $_GET['mobile'] ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>E-mail</label>
                      <input type="email" id="email" class="form-control" name="email" required  value="<?php echo $_GET['email'] ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Quotation Date</label>
                      <input type="date" id="date" class="form-control" name="quot_date" required value="<?php echo $_GET['quot_date'] ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label>Address</label>
                  <textarea rows="2" id="address"class="form-control" name="address" required><?php echo $_GET['address'] ?></textarea>
        ...
        <table class="table table-bordered table-hover" id="tireFields">
          <table id="invoice-item-table" class="table table-bordered">
            ...
            <tr>
              ...
              <td><input type="text" name="sqft[]" id="sqft" data-srno="1" class="form-control input-sm number_only sqft" /></td>
              <td><input type="text" name="rate[]" id="rate" data-srno="1" class="form-control input-sm rate"/></td>
           ...
           value="<?php echo $_GET['total'] ?>">      </td>
            ...
            <tr>
              <td colspan="3" style="text-align: right ">
                ...
                <td colspan="4" style="text-align: right; " >
               <input type="text" class="form-control" style="width: 200px;" name="cgst"
               value="<?php echo $_GET['cgst'] ?>">      </td>
              </tr>
            ...
            <tr>
              <td colspan="3" style="text-align: right ">
                ...
                <td colspan="4" style="text-align: right; " >
               <input type="text" class="form-control" style="width: 200px;" name="sgst"
               value="<?php echo $_GET['sgst'] ?>">      </td>
            ...
            <tr>
              <td colspan="3" style="text-align: right ">
                ...
                <td colspan="4" style="text-align: right; " >
               <input type="text" class="form-control" style="width: 200px;" name="grand_total"value="<?php echo $_GET['grand_total'] ?>" >      </td>
